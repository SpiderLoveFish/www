...
//		var dataArray = s[0];
	 ...
	 // alert(obj[0].ComponentName)
		...
		$('#Workzje').text(obj[0].DiscountAmount);
		$('#Workjjje').text(obj[0].JJAmount);
		$('#Workzcje').text(obj[0].ZCAmount);
		$('#Workfjje').text(obj[0].FJAmount);
                   ...
                   // 	alert(data[i]['brand'] )
                       ...
                       if (data[i]['ComponentName'] != cn) {
                           item = "<tr><td align='left' colspan='9' ><font size='2' ><b>&nbsp;&nbsp;" + data[i]['ComponentName'] + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(合计：" + data[i]['BwSubTotal'] + ")</b></font></td></tr>"
                               + "<tr><td >"+ data[i]['brand'] + "</td><td align='right'>" + data[i]['zc_price'] + "</td><td align='right'>" + data[i]['fc_price'] + "</td><td align='right'>" + data[i]['rg_price']  + "</td><td align='right'>" + data[i]['TotalPrice']  + "</td><td align='right'>" + sum  + "</td> "
                               + " <td align='right'>" + data[i]['je']  + "</td><td>" + data[i]['unit'] + "</td> "//<td>" + data[i]['proremarks'] + "</td>
                               + " </tr>";
                       }
                       else {
                           item = "<tr><td>" + data[i]['brand'] + "</td><td align='right'>" + data[i]['zc_price'] + "</td><td align='right'>" + data[i]['fc_price'] + "</td><td align='right'>" + data[i]['rg_price']  + "</td><td align='right'>" + data[i]['TotalPrice'] + "</td><td align='right'>" + sum  + "</td> "
                               + " <td align='right'>" + data[i]['je'] + "</td><td>" + data[i]['unit'] + "</td> "//<td>" + data[i]['proremarks'] + "</td>
                               + " </tr>";
                    }
                       $('.table1').append(item);
